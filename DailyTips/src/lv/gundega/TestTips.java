...
public class TestTips {
	...
	public static void main(String[] args) throws Exception {
		...
		String answer;
		Scanner scan = new Scanner(System.in);
		System.out.println("Hi! I will try to help you with some ideas to make your day better! To do that, please ");
...
//*****************************************************WOMAN******************************************************************
		...
		if (answer.equals("female")) {
		    ...
		    System.out.println("      *");
		    System.out.println("      *");
			System.out.println("If you want to get tip, type GET, if you want to add tips, type ADD!");
