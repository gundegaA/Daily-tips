...
public class PrintTipsForMan {
	...
	// ############METHOD ADD TIPS FOR MAN
	public void addTipForMan(String text) {
		try {
			File fileObj = new File("tipsForMan.txt");
	...
	public void removeLineFromFile(String lineToRemove) {
		...
		try {
			File file = new File("tipsForMan.txt");
			File inFile = new File("tipsForMan.txt");
	...
	public void removeEmptyLine() {
        ...
        try {
            file = new Scanner(new File("tipsForMan.txt"));
            writer = new PrintWriter("tipsForMan1.txt");
            ...
            File file1 = new File("tipsForMan.txt");
            File file2 = new File("tipsForMan1.txt");
            file1.delete();
